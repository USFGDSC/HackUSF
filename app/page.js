      ...
      <div className={styles.container}>
        ...
        <div id="about" className={styles.about}>
          <div className={styles.aboutDesc}>
            <p>The Google Developer Student Club at USF is hosting its first-ever <b>24-hour Hackathon</b>, bringing students together to innovate, build, and compete.</p>
          </div>
          <div className={styles.location}>
            <h2>Location</h2>
            <div>
              <a href="https://www.google.com/maps/place/ENB+-+Engineering+Building+II/@28.0586369,-82.418115,17z/data=!3m1!5s0x88c2c7b965c77a61:0x6d775b457200a0a9!4m10!1m2!2m1!1senb+usf!3m6!1s0x88c2c7b963af1e73:0x885216ce5072fc9b!8m2!3d28.0585491!4d-82.4156104!15sCgdlbmIgdXNmkgESZW5naW5lZXJpbmdfc2Nob29s4AEA!16s%2Fg%2F11clyt2m6n?entry=ttu&g_ep=EgoyMDI1MDEyNi4wIKXMDSoASAFQAw%3D%3D" target="_blank">ENB - Engineering Building II on USF Campus</a>
            </div>
            <div>
              3820 USF Alumni Drive, Tampa, FL 33620
            </div>
            <iframe
